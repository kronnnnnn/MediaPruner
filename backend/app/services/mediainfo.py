...
def _get_channel_layout(channels: int, channel_layout: Optional[str] = None) -> str:
...
def _detect_hdr(video_track) -> Optional[str]:
    ...
    hdr_format_commercial = getattr(video_track, 'hdr_format_commercial', '') or ''
        ...
        for track in media_info.tracks:
            if track.track_type == 'General':
                ...
                if track.overall_bit_rate:
                    result.overall_bitrate = int(track.overall_bit_rate / 1000)  # bps to kbps
                break
