...
class DatabaseLogHandler(logging.Handler):
    ...
    def __init__(self, database_url: str, level: int = logging.INFO):
        ...
        self.engine = create_engine(sync_url, connect_args={"check_same_thread": False})
...
def setup_database_logging(level: int = logging.INFO) -> None:
    ...
    for logger_name in ['app.services.tmdb', 'app.services.omdb', 'app.services.scanner', 
                        'app.services.renamer', 'app.services.mediainfo', 'app.routers']:
