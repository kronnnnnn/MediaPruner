...
- Automated approvals: We run a GitHub Actions workflow that will auto-approve PRs via **`github-actions[bot]`** when the `CI` workflow completes successfully. This lets you merge your own PRs after CI passes while keeping branch protections strict.
